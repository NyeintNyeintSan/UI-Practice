            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text("Fashion,Style",style: TextStyle(color: Colors.blue,
...
//                  Icon(MdiIcons.waterOutline,color: (isGardening==true)?changedIconColor:iconColor,),
                ...
                Container(
                  margin: EdgeInsets.only(left:25.0),
                  child: Text("Favourites",style: TextStyle(color: Colors.blue,
//                      fontWeight: FontWeight.bold,
                      fontSize: 15
                  ),),
                ),
...
//                      fontWeight: FontWeight.bold,fontSize: 16
                ...
                Container(
                  margin: EdgeInsets.only(left:25.0),
                  child: Text("Life Style",style: TextStyle(color: Colors.blue,
//                      fontWeight: FontWeight.bold,
                      fontSize: 15
                  ),),
                ),
