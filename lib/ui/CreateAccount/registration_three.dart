...
//                Icon(Icons.assignment)
                Text("Address",style: TextStyle(
                  fontWeight: FontWeight.bold,fontSize: 22,color: Colors.lightGreen,
//                  shadows:<Shadow>[
//                    Shadow(
...
//                     ),
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              child: Text("Region/State",style: TextStyle(color: Colors.green,fontSize: 16),),
                              padding: EdgeInsets.only(left: 10),
                            ),
                            Container(
                              width: 350,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
//                      Container(
//                        child: Text("City",style: TextStyle(color: Colors.green,fontSize: 16),),
//                        padding: EdgeInsets.only(left: 10),
//                      ),
                      Container(
                        child: TextFormField(
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => RegistrationFour())
                    );
                  },
                  child: Container(
